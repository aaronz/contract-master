...
## Active Technologies
- Java 17 (Backend), Vue 3 (Frontend) + Spring Boot 3.2.x, Spring Data JPA, Kafka (Backend); Element Plus (Frontend) (001-contract-reevaluation)
...
# Add commands for Java 17 (Backend), Vue 3 (Frontend)
