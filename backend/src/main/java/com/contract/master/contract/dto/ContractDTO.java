...
public class ContractDTO {
    ...
    private TenantId tenantId; // Changed to TenantId
    ...
    public TenantId getTenantId() { return tenantId; } // Changed return type
    public void setTenantId(TenantId tenantId) { this.tenantId = tenantId; } // Changed parameter type
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(contractId, that.contractId) && Objects.equals(contractNo, that.contractNo) && Objects.equals(crmContractId, that.crmContractId) && Objects.equals(contractType, that.contractType) && Objects.equals(contractName, that.contractName) && Objects.equals(partyAId, that.partyAId) && Objects.equals(partyAName, that.partyAName) && Objects.equals(partyAContact, that.partyAContact) && Objects.equals(partyAPhone, that.partyAPhone) && Objects.equals(partyAAddress, that.partyAAddress) && Objects.equals(partyBId, that.partyBId) && Objects.equals(partyBName, that.partyBName) && Objects.equals(partyBContact, that.partyBContact) && Objects.equals(partyBPhone, that.partyBPhone) && Objects.equals(partyBAddress, that.partyBAddress) && Objects.equals(contractAmount, that.contractAmount) && Objects.equals(taxRate, that.taxRate) && Objects.equals(taxAmount, that.taxAmount) && Objects.equals(totalAmountWithTax, that.totalAmountWithTax) && Objects.equals(currencyType, that.currencyType) && Objects.equals(paymentMethod, that.paymentMethod) && Objects.equals(paymentTerm, that.paymentTerm) && Objects.equals(invoiceType, that.invoiceType) && Objects.equals(invoiceTitle, that.invoiceTitle) && Objects.equals(taxpayerId, that.taxpayerId) && Objects.equals(signDate, that.signDate) && Objects.equals(effectiveDate, that.effectiveDate) && Objects.equals(expireDate, that.expireDate) && Objects.equals(performanceLocation, that.performanceLocation) && Objects.equals(performanceMethod, that.performanceMethod) && Objects.equals(performanceStartDate, that.performanceStartDate) && Objects.equals(performanceEndDate, that.performanceEndDate) && Objects.equals(qualityStandard, that.qualityStandard) && Objects.equals(contractStatus, that.contractStatus) && Objects.equals(approvalStatus, that.approvalStatus) && Objects.equals(approvalUser, that.approvalUser) && Objects.equals(ownerUserId, that.ownerUserId) && Objects.equals(ownerDeptId, that.ownerDeptId) && Objects.equals(legalReviewFlag, that.legalReviewFlag) && Objects.equals(legalReviewOpinion, that.legalReviewOpinion) && Objects.equals(disputeResolution, that.disputeResolution) && Objects.equals(governingLaw, that.governingLaw) && Objects.equals(guaranteeFlag, that.guaranteeFlag) && Objects.equals(guaranteeType, that.guaranteeType) && Objects.equals(guarantorInfo, that.guarantorInfo) && Objects.equals(subjectType, that.subjectType) && Objects.equals(subjectDesc, that.subjectDesc) && Objects.equals(subjectQuantity, that.subjectQuantity) && Objects.equals(unitPrice, that.unitPrice) && Objects.equals(thirdPartyFlag, that.thirdPartyFlag) && Objects.equals(thirdPartyInfo, that.thirdPartyInfo) && Objects.equals(attachments, that.attachments) && Objects.equals(attachmentCount, that.attachmentCount) && Objects.equals(mainAttachmentId, that.mainAttachmentId) && Objects.equals(changeCount, that.changeCount) && Objects.equals(lastChangeTime, that.lastChangeTime) && Objects.equals(remark, that.remark) && Objects.equals(createTime, that.createTime) && Objects.equals(createUser, that.createUser) && Objects.equals(updateTime, that.updateTime) && Objects.equals(updateUser, that.updateUser) && Objects.equals(tenantId, that.tenantId) && Objects.equals(extendedFields, that.extendedFields);
    }

    @Override
    public int hashCode() {
        return Objects.hash(contractId, contractNo, crmContractId, contractType, contractName, partyAId, partyAName, partyAContact, partyAPhone, partyAAddress, partyBId, partyBName, partyBContact, partyBPhone, partyBAddress, contractAmount, taxRate, taxAmount, totalAmountWithTax, currencyType, paymentMethod, paymentTerm, invoiceType, invoiceTitle, taxpayerId, signDate, effectiveDate, expireDate, performanceLocation, performanceMethod, performanceStartDate, performanceEndDate, qualityStandard, contractStatus, approvalStatus, approvalUser, ownerUserId, ownerDeptId, legalReviewFlag, legalReviewOpinion, disputeResolution, governingLaw, guaranteeFlag, guaranteeType, guarantorInfo, subjectType, subjectDesc, subjectQuantity, unitPrice, thirdPartyFlag, thirdPartyInfo, attachments, attachmentCount, mainAttachmentId, changeCount, lastChangeTime, remark, createTime, createUser, updateTime, updateUser, tenantId, extendedFields);
    }
}
