...
## Recent Changes
- 001-ui-test-suite: Added Java 17 + Playwright 1.41.2, JUnit 5, AssertJ

- 001-contract-master-core: Added Java 17, Vue 3 + Spring Boot 3.2.x, Spring Data JPA, Spring AI (OpenAI/Azure), Drools 9.x, Kafka, Element Plus
